    ...
    <div>
      ...
      <Flex className={classes.flexColMobile}>
        <Flex gap={30} vertical className={classes.bannerInfo}>
          <h1>{translate('discover_us')}</h1>
          <p>{translate('discover_us_text')}</p>
          <h1>{translate('visit_us')}</h1>
          <p>{contact && contact.record.location}</p>
          <h1>{translate('email_us')}</h1>
          <p>{contact && contact.record.email}</p>
        </Flex>
      ...
      <Flex className={classes.formContainer} gap={70} justify='space-between'>
        <Flex vertical className={classes.formText}>
          <h1 className={classes.title}>{translate('contact_form_title')}</h1>
          <p>{translate('contact_form_text')}</p>
        </Flex>
